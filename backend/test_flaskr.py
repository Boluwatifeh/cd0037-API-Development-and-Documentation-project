...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}".format(TESTDB_USER, TESTDB_PASSWORD,'localhost:5432', TESTDB_NAME)
    ...
    def test_get_all_questions_paginated_error(self):
        ...
        check = self.client().get('/questions?page=1000')
        data = json.loads(check.data)
